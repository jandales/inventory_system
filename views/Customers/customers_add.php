              ...
              <?php error_message() ?>
                <div class="form_panel">
                  <div class="form_title">
                    <h2>Customer Information<small>(Fields in red are required)</small></h2>
...
<div class="form-inline">
                  ...
                  <div class="form_content">
                       <form class="form-horizontal" method="post" action="./core/Request/Costumers/add.php" id="form1" runat="server" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text"  name="campany"  class="form-control col-md-7 col-xs-12 textbox"  >
                        </div>
                      </div>
